...
\section{Skills}
 \resumeSubHeadingListStart
   \item{\textbf{Languages}{: Python, JavaScript, PHP, SQL, Postgres, MongoDB}}
   \item{\textbf{Technologies}{: React, NextJs, Angular, NodeJs, Laravel, Docker, Agile, AWS, Google Cloud API, Firebase, Supabase, GraphQL}}
 \resumeSubHeadingListEnd
